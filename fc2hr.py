...
Author: Ruihan Zhang
Date: 2023-10-18
Description: Convert the ph.fc (generated by q2r.x in Quantum ESPRESSO) into the wannier90_hr.dat format (cm^{-1}).
"""
    ...
    for j in range(27):
        ...
        if abs(super_dis - sp_dis) < eps:
            for l in range(9):
                ...
                newsp_p[k+l*count][3] = super_poshb[i+l*nat*nat*ntot+j*nat_l*ntot][3]*mue[k+l*count].item()
